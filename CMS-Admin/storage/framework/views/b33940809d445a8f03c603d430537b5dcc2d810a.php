<?php $__env->startSection('title'); ?> Add Tab <?php $__env->stopSection(); ?>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php endif; ?>
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('tab.store')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <textarea  id="description" type="text" class="form-control" name="description"><?php echo e(old('description')); ?></textarea>
