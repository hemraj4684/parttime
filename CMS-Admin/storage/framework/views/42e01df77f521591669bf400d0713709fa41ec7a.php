...
<section class="wrapper main-wrapper row">
        ...
        <div class="page-title">
          ...
          <div class="pull-right hidden-xs">
            <ol class="breadcrumb">
              ...
              <li> <a href="<?php echo e(url('/orgadmin')); ?>">Organization Admins</a> </li>
        ...
        <section class="box clients-list">
          <header class="panel_header">
            <h2 class="title pull-left"> <i class="fa fa-user"></i> &nbsp; Organization Admins	</h2>
                    ...
                    <a href="<?php echo e(url('/orgadmin/adduser')); ?>" title="Add Organization Admin" class="btn btn-primary btn-sm pull-right title addUser">Add Organization Admin</a>
                   <?php }?>
          </header>
  ...
  <div class="clearfix"></div>
 <form method="POST" id="searchform" action="<?php echo e(url('/orgadmin/searchres')); ?>" role="form"  >	
            ...
            <div class="content-body">
              <div class="row">
     <form method="POST" action="<?php echo e(url('/orgadmin/adsearch')); ?>" role="form"  >	
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                 <div class="col-xs-12">
                  ...
                  <div class="vertical">
                    <div class="tab-pane">
                      ...
                      <tr id="<?php echo e($user->id); ?>1">
                        <td class="client-avatar"><img alt="" src="<?php echo e(URL::asset('public/theme/data/profile/profile.jpg')); ?>" class="img-responsive img-circle" width="22px"> <i class="fa fa-circle offline"> </i></td>
                          ...
                          <td>
                          	<?php if($curent_role == 1) {?>
                                <a href="<?php echo e(route('orgadmin.edit',$user->id)); ?>"  style="margin-right: 3px;"><i class="fa fa-pencil icon-xs CmmTab"></i></a>
                                <?php }?>
                            <a onClick="showdiv(<?php echo e($user->id); ?>)" style="cursor:pointer;"><i class="glyphicon glyphicon-eye-open CmmTab"></i></a>
                            	<?php if($curent_role == 1) {?>
                          <a href="<?php echo e(route('orgadmin.destroy',$user->id)); ?>" class="delete" style="margin-right: 3px;"><i class="fa fa-trash icon-xs CmmTab"></i></a>
                          <?php }?>
                          </td>
          ...
          <div class="content-body">
            <div class="row">
              <div class="col-xs-12 ">
                ...
                <span class="btn btn-success btn-xs"><?php if($user->status == 1): ?>Active <?php else: ?> InActive <?php endif; ?></span>
              </div>
			    <div class="clearfix"></div>
			  <hr>
