...
<section class="wrapper main-wrapper row" style=''>
    ...
    <div class="row">
     ...
     <?php echo e(Form::open( ['role' => 'form','class'=>'form-horizontal', 'route' => ['orgcontracts.store']])); ?>	
    ...
    <div class="tab-pane active" id="pills-tab4">
      ...
      <br>
        ...
        <label class="form-label"><?php echo e(trans('contracts.heading1')); ?> <span class="required">*</span>
                        ...
                        <div class="controls">
                           <?php echo Form::select('org_id',  ['' => 'Select Organisation'] + $orgs, $curorg, ['class' => 'form-control']); ?>
...
<div class="form-group">
                        ...
                        <div class="controls">
                           <?php echo e(Form::text('contract_start_date', null, ['class' => 'datepicker form-control','onkeyup' => 'lastdate()','id'=>'lastdate'])); ?>

                            <?php if($errors->has('contract_start_date')): ?>
                                    <span class="help-block" style="color:red;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="controls">
                           <?php echo e(Form::text('contract_end_date', null, ['class' => 'form-control ','id'=>'yeardate'])); ?>
