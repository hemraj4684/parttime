       ...
       <div class="page-title">
            ...
            <div class="pull-left">
             ...
             <ol class="breadcrumb">
              ...
              <li> <a href="<?php echo e(url('/orgsupport')); ?>">Org Professional Service Users</a> </li>
...
<?php echo e(Form::open( ['role' => 'form','class'=>'form-horizontal', 'route' => ['orgsupport.store']])); ?>	
...
<div class="form-group">
                        <label class="form-label col-sm-12" for="org-name"><?php echo e(trans('org_service.heading2')); ?><span class="required">*</span>
                        </label>
                        <div class="controls col-sm-12">
    
<?php echo Form::select('user_id',  ['' => 'Select Service User'] + $roles, null, ['class' => 'form-control col-md-7 col-xs-12']); ?>
