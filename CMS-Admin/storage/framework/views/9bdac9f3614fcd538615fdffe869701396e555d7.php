...
<section class="wrapper main-wrapper row">
      ...
      <div class="col-lg-12" id="leftdiv">
        <section class="box clients-list">
          <header class="panel_header">
            <h2 class="title pull-left"> <i class="fa fa-user"></i> &nbsp; Support Users	</h2>
			
                	
                    <a href="<?php echo e(url('/orgsupport/create')); ?>" title="Add Support User" class="btn btn-primary btn-sm pull-right title addUser">Add Support User</a>
  ...
  <div class="clearfix"></div>
                  ...
                  <div class="vertical">
                    <div class="tab-pane">
                      ...
                      <?php foreach($users as $user): ?>
                        ...
                        <tr id="<?php echo e($user->org_sup_id); ?>1">
                        <td class="client-avatar"><img alt="" src="<?php echo e(URL::asset('public/theme/data/profile/profile.jpg')); ?>" class="img-responsive img-circle" width="22px"> <i class="fa fa-circle online"> </i></td>
                          ...
                          <td>
                          <a href="<?php echo e(route('orgsupport.edit',$user->org_sup_id)); ?>" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" data-toggle="tooltip" data-original-title="Edit" data-placement="left"><i class="fa fa-pencil icon-xs CmmTab"></i></a>
                          <a onClick="showdiv(<?php echo e($user->org_sup_id); ?>)" style="cursor:pointer;"><i class="glyphicon glyphicon-eye-open CmmTab"></i></a>
                          <a href="<?php echo e(route('orgsupport.destroy',$user->org_sup_id)); ?>" class="delete" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn CmmTab" data-toggle="tooltip" data-original-title="Delete" data-placement="left"><i class="fa fa-trash icon-xs CmmTab"></i></a>
      ...
      <div class="col-lg-4" id="rightdiv" style="display:none;">
        ...
        <section class="box closeopen" id="<?php echo e($user->org_sup_id); ?>" style="display:none;"> <br/>
          <div class="content-body">
            <div class="row">
