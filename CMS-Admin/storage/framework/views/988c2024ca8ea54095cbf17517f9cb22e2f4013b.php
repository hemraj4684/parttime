...
<?php if(Auth::user()): ?><h3> <a href="<?php echo e(url('/')); ?>"><?php echo e(Auth::user()->username); ?></a> <?php endif; ?>
...
<?php if(Auth::user()): ?><?php $curent_role = Auth::user()->role_id; ?>
...
<li> <a href="<?php echo e(url('/roles/create')); ?>"> 
<i class="fa fa-check-square"></i> <span class="title">Roles</span>
</a>  </li>
<li> <a href="<?php echo e(route('tab.index')); ?>"> 
<i class="fa fa-check-square"></i> <span class="title">Tabs</span>
</a>  </li>
<li> <a href="<?php echo e(route('module.index')); ?>"> 
<i class="fa fa-check-square"></i> <span class="title">Modules</span>
</a>  </li>
<li> <a href="<?php echo e(url('/permission')); ?>"> 
<i class="fa fa-check-square"></i> <span class="title">Permissions</span>
</a>  </li>
<li> <a href="<?php echo e(route('role.permission.view')); ?>"> 
