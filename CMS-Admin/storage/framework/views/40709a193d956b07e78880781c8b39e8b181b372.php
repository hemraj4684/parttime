...
<section class="wrapper main-wrapper row permitions" style=''>
 ...
 <?php echo e(Form::model($services, ['role' => 'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal' ,'route' => ['services.update', $services->service_id], 'method' => 'PUT'])); ?>
  ...
  <input type="hidden" name="Userparent" value="<?php echo Auth::user()->parent_id; ?>">	
                  ...
                  <div class="form-group">
                    <label class="form-label" ><?php echo e(trans('services.heading1')); ?></label>
                  ...
                  <div class="form-group">
                    <label class="form-label" ><?php echo e(trans('services.heading2')); ?></label>
                    <span class="desc"></span>
                    <div class="controls">
                   ...
                   <div class="form-group">
                    ...
                    <span class="desc"></span>
                    <div class="controls">
                    <img alt="image"  src="<?php echo e(URL::asset('public/services/'.$services->service_logo)); ?>" style="width: 62px">
