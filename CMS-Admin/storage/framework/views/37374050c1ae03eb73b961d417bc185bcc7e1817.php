...
<form method="POST" name="MyForm" action="<?php echo e(url('/permissions')); ?>" accept-charset="UTF-8" role="form" class="form-horizontal createPermi" id="msg_validate1" data-toggle="validator" >
