...
<?php $__env->startSection('content'); ?>
 ...
 <section class="wrapper main-wrapper row" style=''>
    ...
    <!-- MAIN CONTENT AREA STARTS -->
	  <?php echo e(Form::open( ['role' => 'form','class'=>'' ,'route' => ['users.store']])); ?>
              ...
              <div class="row">
                  ...
                  <div class="col-xs-6" >
                    <div class="form-group">
                      ...
                      <span class="desc"></span>
                      <div class="controls">
                      <?php echo e(Form::text('username', null, ['id'=>'unamee','readonly'=>'readonly','class' => 'form-control col-md-7 col-xs-12'])); ?>
