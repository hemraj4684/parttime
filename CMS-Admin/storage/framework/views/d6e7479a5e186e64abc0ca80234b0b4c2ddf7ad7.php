 <?php $__env->startSection('title'); ?> Edit Privilege <?php $__env->stopSection(); ?>
...
<?php echo e(Form::model($privileges, ['role' => 'form', 'class'=>'form-horizontal' ,'route' => ['privileges.update', $privileges->privilege_id], 'method' => 'PUT','data-toggle'=>'validator'])); ?>	
