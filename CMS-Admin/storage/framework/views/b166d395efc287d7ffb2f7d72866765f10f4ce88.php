  ...
  <div class='quick-area'>
            ...
            <li class="list">
              <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                <li class="unread status-available"> <a href="javascript:;">
                  <div class="user-img"> <img src="<?php echo e(URL::asset('public/theme/data/profile/avatar-1.png')); ?>" alt="user-image" class="img-circle img-inline"> </div>
    ...
    <div class='pull-right'>
      <ul class="info-menu right-links list-inline list-unstyled">
        <li class="profile"> <a href="#" data-toggle="dropdown" class="toggle"> <img src="<?php echo e(URL::asset('public/theme/data/profile/profile.jpg')); ?>" alt="user-image" class="img-circle img-inline"> <span><?php echo e(Auth::user()->username); ?> <i class="fa fa-angle-down"></i></span> </a>
          <ul class="dropdown-menu profile animated fadeIn">
           <li> <a href="<?php echo e(url('/users/'.Auth::user()->id)); ?>/profile"> <i class="fa fa-wrench"></i> Settings </a> </li>
 			  <li> <a href="#help"> <i class="fa fa-info"></i> Help </a> </li>
            <li class="last"> <a href="<?php echo e(url('/logout')); ?>"> <i class="fa fa-lock"></i> Logout </a> </li>
          </ul>
        </li>
