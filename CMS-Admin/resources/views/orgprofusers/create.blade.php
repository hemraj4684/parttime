...
{{ Form::open( ['role' => 'form','novalidate'=>'','id'=>'general_validate1','class'=>'form-horizontal', 'route' => ['orgprofusers.store']]) }}	
...
{!! Form::select('user_id',  ['' => 'Select Service User'] + $roles, null, ['class' => 'form-control col-md-7 col-xs-12','required'=>'required']) !!}
