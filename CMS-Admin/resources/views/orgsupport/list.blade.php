...
<section class="wrapper main-wrapper row">
        ...
        <div class="page-title">
          ...
          <div class="pull-right hidden-xs">
            <ol class="breadcrumb">
              ...
              <li> <a href="{{ url('/orgsupport') }}">Professional Service Users</a> </li>
        ...
        <section class="box clients-list">
          <header class="panel_header">
            <h2 class="title pull-left"> <i class="fa fa-user"></i> &nbsp; Support Users	</h2>
                    ...
                    <a href="{{ url('/orgsupport/create') }}" title="Add Support User" class="btn btn-primary btn-sm pull-right title addUser">Add Support User</a>
  ...
  <div class="clearfix"></div>
                    ...
                    <div class="tab-pane">
                      ...
                      @foreach($users as $user)
                        ...
                        <td class="client-avatar"><img alt="" src="{{ URL::asset('public/theme/data/profile/profile.jpg') }}" class="img-responsive img-circle" width="22px"> <i class="fa fa-circle online"> </i></td>
                          ...
                          <td>
                          <a href="{{route('orgsupport.edit',$user->org_sup_id)}}" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" data-toggle="tooltip" data-original-title="Edit" data-placement="left"><i class="fa fa-pencil icon-xs CmmTab"></i></a>
                          <a onClick="showdiv({{ $user->org_sup_id }})" style="cursor:pointer;"><i class="glyphicon glyphicon-eye-open CmmTab"></i></a>
                          <a href="{{route('orgsupport.destroy',$user->org_sup_id)}}" class="delete" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn CmmTab" data-toggle="tooltip" data-original-title="Delete" data-placement="left"><i class="fa fa-trash icon-xs CmmTab"></i></a>
      ...
      <div class="col-lg-4" id="rightdiv" style="display:none;">
        ...
        <section class="box closeopen" id="{{ $user->org_sup_id }}" style="display:none;"> <br/>
          <div class="content-body">
            <div class="row">
