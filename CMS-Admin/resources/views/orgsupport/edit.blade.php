...
<section class="wrapper main-wrapper row" style=''>
    ...
    <div class="row">
				...
				{{ Form::model($users, ['role' => 'form','class'=>'form-horizontal', 'route' => ['orgsupport.update', $users->org_sup_id], 'method' => 'PUT']) }}		
...
<div class="form-group">
                        <label class="form-label col-sm-12" for="User-name">{{ trans('org_service.heading2')}}<span class="required">*</span>
                        </label>
                        <div class="controls col-sm-12">
    
{!! Form::select('user_id',  ['' => 'Select Professional Service'] + $roles, null, ['class' => 'form-control col-md-7 col-xs-12']) !!}
