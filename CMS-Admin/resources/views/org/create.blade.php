...
<section class="wrapper main-wrapper row" style=''>
                    ...
                    <div class="">
                      ...
                      <div class="">
                       ...
                       <div class="">
                        ...
                        <div class="controls">
                           <input class="form-control col-md-7 col-xs-12"  name="address_line21" type="text" id="adl2"> @if ($errors->has('address_line21'))
                                    <span class="help-block" style="color:red;">
                                        <strong>Enter Address</strong>
                                    </span>
                                @endif 
            ...
            <input class="form-control col-md-7 col-xs-12"  name="fax1" type="text">
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="">
                        ...
                        <div class="controls">
                           <input class="form-control col-md-7 col-xs-12 cityLat"  name="latitude1" id="latitude1" type="text">  @if ($errors->has('latitude1'))
                                    <span class="help-block" style="color:red;">
 ...
 <div class="">
                        ...
                        <div class="controls">
                           <input class="form-control col-md-7 col-xs-12" id="adl22"  name="address_line22" type="text"> @if ($errors->has('address_line22'))
                                    <span class="help-block" style="color:red;">
                                        <strong>Enter Address </strong>
                                    </span>
                                @endif
            ...
            <input class="form-control col-md-7 col-xs-12"  name="fax2" type="text">
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="">
                        ...
                        <div class="controls">
                           <input class="form-control col-md-7 col-xs-12 cityLat"  name="latitude2" id="latitude2" type="text">  @if ($errors->has('latitude2'))
                                    <span class="help-block" style="color:red;">
