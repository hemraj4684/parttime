...
<section class="wrapper main-wrapper row" style=''>
   ...
   <div class="col-xs-12">
                        ...
                        <div class="col-md-12 col-lg-6">
                          <div class="row">
                            <div class="form-group">
                              <label class="form-label control-label col-lg-3 col-sm-12">Organization Name</label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="controls col-sm-12 col-lg-9">
                                <input type="text" placeholder="Headquarters" class="form-control" name="Headquarters">
                              </div>
                            </div>
                            <div class="clearfix"></div>
                          </div>
                    ...
                    <div class="panel-body">
                      <div class="row">
                        <div class="col-md-12 col-lg-6">
                          <div class="row">
                            <div class="form-group">
                              <label class="form-label control-label col-lg-3 col-sm-12" >Address First line</label>
                              <div class="controls col-sm-12 col-lg-9">
                                <input type="text" placeholder="Address First line" class="form-control" name="Address First line">
                              </div>
                            </div>
                            <div class="clearfix"></div>
							<div class="form-group">
                              <label class="form-label control-label col-lg-3 col-sm-12" >Address Second line</label>
                              <div class="controls col-sm-12 col-lg-9">
                                <input type="text" placeholder="Address Second line" class="form-control" name="Address Second line">
                              </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" placeholder="Enter Organization Admin Name" class="form-control" name="numID">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="controls">
                    <input type="text" placeholder="Enter Organization Admin Email" class="form-control" name="Email">
                  </div>
                </div>
              </div>
            </div>
          ...
          <form method="get">
            <div class="form-group col-md-offset-3">
              <div class="col-md-2 col-xs-12">
                <label class="btn btn-primary"><img src="../assets/images/media.jpg" alt="..." class="img-thumbnail img-check">
    ...
    <div class="tab-pane" id="pills-tab5">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label class="form-label col-sm-4 col-xs-12" >Name of the Organization</label>
          <div class="col-md-8 col-sm-6 col-xs-12">
            <input type="text" placeholder="Full Name" class="form-control" name="txtFullName" id="txtFullName">
          </div>
        </div>
        <div class="clearfix"></div>
        <p class="form-label">Payment Methods</p>
        <img src="../assets/images/visa.png" alt="Visa"> <img src="../assets/images/mastercard.png" alt="Mastercard"> <img src="../assets/images/american-express.png" alt="American Express"> <img src="../assets/images/paypal.png" alt="Paypal"> </div>
      <div class="col-md-6">
        <div class="form-group">
          <label class="form-label" >Address 2</label>
          <div class="controls">
            <textarea class="form-control" rows="3" placeholder="Headoffice Address"></textarea>
          </div>
        </div>
      </div>
    </div>
    <div class="tab-pane" id="pills-tab6">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label class="form-label" >Profession Service Name</label>
            <div class="controls">
              <input type="text" placeholder="Profession Service Email" class="form-control" name="numID">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label class="form-label" >Profession Service Email</label>
            <div class="controls">
              <input type="text" placeholder="Profession Service Email" class="form-control" name="Email">
            </div>
          </div>
        </div>
      </div>
