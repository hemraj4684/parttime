...
<section class="wrapper main-wrapper row permitions" style=''>
   ...
   {{ Form::open( ['role' => 'form', 'route' => ['services.store'],'files'=>true]) }}
...
<br/>
  <div class="col-md-6 "> <h4>Create Service</h4>  </div>
                  ...
                  <div class="form-group">
                    <label class="form-label" >{{ trans('services.name')}}</label>
                  ...
                  <div class="form-group">
                    <label class="form-label" >{{ trans('services.desc')}}</label>
                    <span class="desc"></span>
                    <div class="controls">
    ...
    <div><strong>Description:</strong>{{ $row->service_desc }}</div>
     ...
     <div><img alt="image" class="img-circle" src="{{ URL::asset('public/services/'.$row->service_logo) }}" style="width: 300px"> </div>
              </div>
