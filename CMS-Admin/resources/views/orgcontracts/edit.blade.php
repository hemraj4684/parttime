...
<section class="wrapper main-wrapper row" style=''>
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                ...
                <h1 class="title">Org Contracts</h1>
    ...
    <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">Edit Org Contract</h2>
    ...
    <div class="row">
      ...
      {{ Form::model($contract, ['role' => 'form', 'class'=>'form-horizontal' ,'route' => ['orgcontracts.update', $contract->org_con_id], 'method' => 'PUT']) }}	
 ...
 {{ Form::text('contract_start_date', null, ['class' => 'datepicker form-control','onkeyup' => 'lastdate()','id'=>'lastdate']) }} @if ($errors->has('contract_start_date'))
        ...
        <label class="form-label">Contracts <span class="required">*</span>
                        ...
                        <div class="controls">
                           {!! Form::select('contract_id',  ['' => 'Select Contract'] + $res_contracts, null, ['class' => 'form-control']) !!}
