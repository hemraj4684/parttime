...
<script src="{{ URL::asset('public/theme/assets/js/icheck.min.js') }}" type="text/javascript"></script> 
<script src="{{ URL::asset('public/theme/assets/plugins/jquery-validation/js/additional-methods.min.js') }}" type="text/javascript"></script> 
...
<!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
<script src="{{ URL::asset('public/theme/assets/plugins/jquery-ui/smoothness/jquery-ui.min.js') }}" type="text/javascript"></script>
 <script src="{{ URL::asset('public/theme/assets/plugins/datepicker/js/datepicker.js') }}" type="text/javascript"></script>
