...
<section class="wrapper main-wrapper row" style=''>
    ...
    <div class="row">
     ...
     {{ Form::open( ['role' => 'form','class'=>'form-horizontal', 'route' => ['contracts.saveuser']]) }}	
 ...
 {{ Form::text('contract_start_date', null, ['class' => 'datepicker form-control','onkeyup' => 'lastdate()','id'=>'lastdate']) }} @if ($errors->has('contract_start_date'))
    ...
    {{ Form::text('contract_end_date', null, ['class' => 'datepicker form-control ','id'=>'yeardate' ]) }}
                      ...
                      <div class="form-group">
                        <label class="form-label">{{ trans('contracts.docsign')}} <span class="required">*</span>
                        </label>
                        <div class="controls">
                           {{ Form::text('doc_sign_url', null, ['class' => 'form-control ']) }}
                            @if ($errors->has('doc_sign_url'))
                                    <span class="help-block" style="color:red;">
                                        <strong>Enter Docu sign URL</strong>
                                    </span>
                                @endif
                        </div>
                      </div>
