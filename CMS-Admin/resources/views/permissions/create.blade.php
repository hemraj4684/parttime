...
<form method="POST" name="MyForm" action="{{ url('/permissions') }}" accept-charset="UTF-8" role="form" class="form-horizontal createPermi" id="msg_validate1" data-toggle="validator" >
  ...
  <br/>
  <div class="col-md-6 "> <h4>Create Permission</h4>  </div>
                        <div class="col-md-6 text-right"> 
                         <span  class="btn btn-primary"id="close">X</span></div>
                        	 <div class="clearfix"></div>  
 
                         <div class="form-group">
                        <label class="form-label  col-sm-12 col-lg-1 col-xs-12 control-label">
                        {{ trans('permissions.heading1')}} <span class="required">*</span>
                        </label>
                        <div class="controls col-sm-12 ">
                          
      {{ Form::text('permission_action', null, ['class' => 'form-control col-md-7 col-xs-12']) }}

                     @if ($errors->has('permission_action'))
                                    <span class="help-block" style="color:red;">
                                        <strong>{{ $errors->first('permission_action') }}</strong>
                                    </span>
                                @endif
                        ...
                        {{ trans('permissions.heading2')}} <span class="required">*</span>
                        </label>
                        <div class="controls col-sm-12 ">
    {{ Form::text('permission_desc', null, ['class' => 'form-control col-md-7 col-xs-12']) }}
               ...
               <button type="submit" class="btn btn-primary" onClick="return checkdata()">Submit</button>
                        </div>
                      </div>
                ...
                <div class="search_data">
                  <div class="vertical">
                    <div class="tab-pane">
                     ...
                     <td>
                          <a href="{{route('permissions.edit',$row->permission_id)}}" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" data-toggle="tooltip" data-original-title="Edit" data-placement="left"><i class="fa fa-pencil icon-xs CmmTab"></i></a>
