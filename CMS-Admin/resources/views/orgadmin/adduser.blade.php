    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                ...
                <h1 class="title">Add Org admin User</h1><!-- PAGE HEADING TAG - END -->                            </div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Add Org Admin User</strong>
                        </li>
                    </ol>
                </div>
     ...
     {{ Form::open( ['role' => 'form','class'=>'form-horizontal' ,'route' => ['orgadmin.saveuser']]) }}
          ...
          <section class="box ">
            ...
            <div class="content-body">
              <div class="row">
                  ...
                  <div class="col-xs-6" >
                    <div class="">
                      <label class="form-label" >{{ trans('users.uname')}}<span class="required">*</span></label>
                      <span class="desc"></span>
                      <div class="controls">
		  ...
		  <header class="panel_header">
             ...
             <div class="content-body">
              <div class="row">
                  <div class="col-xs-6" >
                    <div class="">
                      <label class="form-label" >{{ trans('users.org')}}<span class="required">*</span></label>
                      <span class="desc"></span>
                      <div class="controls">
				  ...
				  <div class="col-xs-6">
                    <div class="">
                      <label class="form-label" >{{ trans('users.role')}}<span class="required">*</span></label>
                      <span class="desc"></span>
                      <div class="controls">
