...
<section class="wrapper main-wrapper row" style=''>
    ...
    <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">{{ trans('users.add')}}</h2>
    ...
    <div class="row">
          ...
          <ul class="form-wizard nav nav-pills">
            ...
            <li><a href="#" data-toggle="tab"><span>Choose billing </span></a></li>
            <li><a href="#" data-toggle="tab"><span>Assigning POC</span></a></li>
          </ul>
          ...
          <div class="tab-pane" id="pills-tab1">
            ...
            <br>           
               ...
               {{ Form::open( ['role' => 'form','novalidate'=>'','class'=>'form-horizontal' ,'route' => ['orgadmin.store'],'name' => 'usercreateform','id' => 'general_validate1']) }}
  ...
  {{ Form::text('email', null, ['class' => 'form-control col-md-7 col-xs-12','required'=>'required']) }}
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="users">{{ trans('users.password')}}<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
           
  {{ Form::text('password', null, ['class' => 'form-control col-md-7 col-xs-12','required'=>'required']) }}
