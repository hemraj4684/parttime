...
<section class="wrapper main-wrapper row" style=''>
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                ...
                <h1 class="title">Edit Org admin User</h1><!-- PAGE HEADING TAG - END -->                            </div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Edit Org Admin User</strong>
                        </li>
                    </ol>
                </div>
    ...
    <!-- MAIN CONTENT AREA STARTS -->
	 {{ Form::model($users, ['role' => 'form', 'route' => ['orgadmin.update', $users->id],'class'=>'form-horizontal', 'method' => 'PUT']) }}
             ...
             <div class="content-body">
              <div class="row">
				  ...
				  <div class="col-xs-6">
                    ...
                    <option value="5" selected="selected">Organization Admin</option>
                    </select>
            ...
            <div>
              ...
              <div class="uprofile-name">
                <h3> <a href="#">{{ $users->username }}</a> 
                  ...
                  <!-- Available statuses: online, idle, busy, away and offline --> 
                  <span class="uprofile-status online"></span> </h3>
                <p class="uprofile-title">ID: <span>{{ $users->id }}</span> <br/> <span class="btn btn-success btn-xs">@if($users->status == 1)Active @else InActive @endif</span> </p>
              </div>
              ...
              <!--<div class="uprofile-buttons"> <a class="btn btn-md btn-primary">Forgot Password?</a> <a class="btn btn-md btn-primary">Delet User</a> </div>-->
            </div>
            <div class="clearfix"></div>
            <header class="panel_header">
