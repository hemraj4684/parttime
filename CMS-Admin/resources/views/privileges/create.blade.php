@extends('layouts.app')
 @section('title') Add Privilege @stop
@section('content')
...
<div class="tab-content">
   ...
   {{ Form::open( ['role' => 'form','id'=>'priv_validate','class'=>'form-horizontal' ,'route' => ['privileges.store'],'name' => 'usercreateform','data-toggle'=>'validator']) }}
...
<br/>
  <div class="col-md-6 "> <h4>Create Functional Feature</h4>  </div>
      ...
      {{ Form::text('privilege_action', null, ['class' => 'form-control col-md-7 col-xs-12','data-error'=>'This is required filedd']) }}
					 @if ($errors->has('privilege_action'))
                                    <span class="help-block" style="color:red;">
                                        <strong>{{ $errors->first('privilege_action') }}</strong>
                                    </span>
                                @endif
                        </div>
                      </div>
