...
<section class="wrapper main-wrapper row">
        ...
        <section class="box clients-list">
          <header class="panel_header">
            <h2 class="title pull-left"> <i class="fa fa-user"></i> &nbsp; Org Bills	</h2>
                    ...
                    <a href="{{ url('/orgbills/create') }}" title="Add Org bills" class="btn btn-primary btn-sm pull-right title addUser">Add Org Bill</a>
  ...
  <div class="clearfix"></div>
                    ...
                    <div class="tab-pane">
                      <table class="table  table-hover table-striped">
                        ...
                        <th>Actions</th>
                         ...
                         @if($orgbills)
                      @foreach($orgbills as $row)
                      
                         <tr id="{{ $row->org_bill_id }}1">
                          <td>{{ $row->org_name }}</td>
                          <td>{{ $row->bill_type }}</td>
                         <td><?php if($row->status == 1) echo 'Active'; else echo 'Inactive'; ?></td>
                         
                          
                          <td><a  href="{{route('orgbills.edit',$row->org_bill_id)}}"  style="margin-right: 3px;"><i class="fa fa-pencil icon-xs CmmTab"></i></a>
                          
                          <a onClick="showdiv({{ $row->org_bill_id }})" style="cursor:pointer;"><i class="glyphicon glyphicon-eye-open CmmTab"></i></a>
          
                          <a href="{{route('orgbills.destroy',$row->org_bill_id)}}" class="delete"  style="margin-right: 3px;"><i class="fa fa-trash icon-xs CmmTab"></i></a></td>
                          </tr>
                          @endforeach
                      @else
      ...
      <div class="col-lg-4" id="rightdiv" style="display:none;">
        ...
        <section class="box closeopen" id="{{ $row->org_bill_id }}" style="display:none;"> <br/>
          <div class="content-body">
            <div class="row">
              <div class="col-lg-12 ">                
                
                   <div><strong>Org Name:</strong>{{ $row->org_name }}</div>
   				 <div><strong>Bill Type:</strong>{{ $row->bill_type }}</div>
            <div><strong>Bill Status:</strong>@if($row->status == 1)Active @else InActive @endif</div>
            ...
            <div class="row">
              <div class="col-xs-12"> 
                ...
                <!-- start -->
                <p><strong>{{ $row->org_name }} Timeline </strong></p>
                ...
                <article class="timeline2-entry">
                    <div class="timeline2-entry-inner">
                      ...
                      <div class="timeline2-label">
                        <h2><a href="#"><strong>{{ $row->bill_type }} </strong></a> <span>Updated by</span><p></p>
                  ...
                  <article class="timeline2-entry">
                    <div class="timeline2-entry-inner">
                      ...
                      <div class="timeline2-label">
                        <h2><a href="#"><strong>{{ $row->bill_type }} </strong></a> <span>Updated at</span></h2>
                  ...
                  <article class="timeline2-entry">
                    <div class="timeline2-entry-inner">
                      ...
                      <div class="timeline2-label">
                         <h2><a href="#"><strong>{{ $row->bill_type }}  </strong></a> <span>Created at</span></h2>
                  ...
                  <article class="timeline2-entry">
                    <div class="timeline2-entry-inner">
                      <div class="timeline2-icon bg-info"> <i class="fa fa-dashboard"></i> </div>
                      <div class="timeline2-label">
                        <h2><a href="#"><strong>{{ $row->bill_type }} </strong></a> <span>Create by</span><p></p>
